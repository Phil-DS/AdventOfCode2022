...
def doTheBlizzardRun(start,end, t=0):
    queue = [(t,start)]
...
# print(doTheBlizzardRun(_start,_end)+doTheBlizzardRun(_end,_startm))
there = doTheBlizzardRun(_start,_end)
back = doTheBlizzardRun(_end,_start,t=there)
there_again = doTheBlizzardRun(_start,_end,t=back)
